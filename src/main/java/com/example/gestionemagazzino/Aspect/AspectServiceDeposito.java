...
@Aspect
@Component
public class AspectServiceDeposito {

    @Pointcut(value = "execution(* com.example.gestionemagazzino.Service.DepositoService.*(..))")
    public void metodi() {}

    @Before( value = "metodi()")
    public void log(JoinPoint joinPoint) {
        System.out.println("log to depositoService method " + joinPoint.getSignature().getName());
